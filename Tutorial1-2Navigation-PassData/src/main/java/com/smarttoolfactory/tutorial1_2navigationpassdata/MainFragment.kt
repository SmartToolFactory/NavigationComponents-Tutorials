package com.smarttoolfactory.tutorial1_2navigationpassdata
...
import com.smarttoolfactory.tutorial1_2navigationpassdata.model.Data
...
//            Navigation.findNavController(view).navigate(R.id.bottom_dest)
            ...
            // Create Action
            val action = MainFragmentDirections.actionMainFragmentToBottomFragment(myDataArg)

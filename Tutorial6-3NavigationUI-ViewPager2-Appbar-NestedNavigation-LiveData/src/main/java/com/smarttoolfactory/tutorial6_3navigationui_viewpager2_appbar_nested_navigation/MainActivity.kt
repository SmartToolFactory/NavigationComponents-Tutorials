 ...
 *
 * * Issue with rotation, when device rotated [ActivityFragmentStateAdapter.createFragment] method
...
class MainActivity : AppCompatActivity(), Observer<NavController> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ActivityFragmentStateAdapter(this)
    ...
    private fun setAppbarNavigation(
        adapter: ActivityFragmentStateAdapter,
        position: Int
    ) {
        try {
